...
async def index(request):
    content = open(os.path.join(ROOT, "server.html"), "r").read()
    return web.Response(content_type="text/html", text=content)


async def javascript(request):
    content = open(os.path.join(ROOT, "server.js"), "r").read()
...
if __name__ == "__main__":
    ...
    # app.router.add_post("/offer", offer) # Removed for testing purpose
    web.run_app(
